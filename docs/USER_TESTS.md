...
- The previous release passed all 9 connected tests on a hosted Android 14 emulator at the Xperia 1 VI's 1080×2340 resolution: [workflow run 31154139372](https://github.com/dyjagger/yomilens/actions/runs/31154139372). The v0.1.5 collision and OCR-noise changes add collision and right-to-left camera-coordinate UI tests; the release workflow must pass before publication.

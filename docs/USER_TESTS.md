...
- The connected suite includes a virtual-camera automatic capture cycle, a crop/rotation/orientation/resource-lifecycle test, and a bundled-model OCR smoke test.
